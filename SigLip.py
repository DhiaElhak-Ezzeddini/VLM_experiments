...
class SiglipEncoderLayer(nn.Module):
    ...
    def forward(self,hidden_states:torch.Tensor):
        ...
        nlp_output = self.mlp(hidden_states)
        hidden_states = mlp_residual + nlp_output
...
class SiglipVisionEmbeddings(nn.Module):
    ...
    def forward(self,pixel_values):
        ...
        patch_embeddings = patch_embeddings.flatten(2).transpose(1,2) ## (B,num_patches,embed_dim)
        embeddings = patch_embeddings + self.position_embeddings(self.position_ids)
